...
public partial class _Default : System.Web.UI.Page
{
    ...
    public void BindCallDetailsGridByCallStatus()
    {
        ...
        if (IsAdmin)
        {
            dsCDData = objTCBAL.GetCallDetailsByCallStatusForAdmin(ddlCallStatus.SelectedValue, ApplicationID);
        }
        else
        {
    ...
    public void BindCallDetailsGridByDate()
    {
        ...
        if (IsAdmin)
        {
            dsCDData = objTCBAL.GetCallDetailsByDateForAdmin(dtFromDate, dtToDate, ApplicationID);
        }
        else
        {
    ...
    protected void gvCallDetails_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "lnkDetails")
            {
                ...
                strTicketNumber = Convert.ToString(e.CommandArgument);
				
				
				if (strTicketNumber != null && strTicketNumber !="")
                {
        ...
        try
        {
            ...
            if (strCallType == "Request")
            {
                ...
                if (dsApprover.Tables.Count > 0)
                {
                    ...
                    strbCallDetails.Append("<tr><td align=" + "left" + "><b>First Approver Contactno</b></td><td><b>:</b></td><td align=" + "left" + ">" + Convert.ToString(dtApprover.Rows[0]["ApproverContactno"]) + "</td></tr>");
					...
					strbCallDetails.Append("<tr><td align=" + "left" + "><b>Second Approver Contactno</b></td><td><b>:</b></td><td align=" + "left" + ">" + Convert.ToString(dtApprover.Rows[0]["SApproverContactno"]) + "</td></tr>");
                }
                else
                {
                    ...
                    strbCallDetails.Append("<tr><td align=" + "left" + "><b>First Approver Contactno</b></td><td><b>:</b></td><td align=" + "left" + ">" + Convert.ToString(dtCallDetails.Rows[0]["ApproverContactno"]) + "</td></tr>");
					...
					strbCallDetails.Append("<tr><td align=" + "left" + "><b>Second Approver Contactno</b></td><td><b>:</b></td><td align=" + "left" + ">" + Convert.ToString(dtCallDetails.Rows[0]["SApproverContactno"]) + "</td></tr>");
                }
			...
			strbCallDetails.Append("<tr><td align=" + "left" + "><b>Expected Close Date</b></td><td><b>:</b></td><td align=" + "left" + ">" + Convert.ToString(dtCallDetails.Rows[0]["ExpectedCloseDate"]) + "</td></tr>");
