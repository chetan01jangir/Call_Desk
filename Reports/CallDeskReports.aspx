<%@ Page Language="C#" MasterPageFile="~/Masters/MasterPage.master" AutoEventWireup="true"
    CodeFile="CallDeskReports.aspx.cs" Inherits="Reports_CallDeskReports" Theme="SkinFile"
    Title=":: Call Desk - Reports ::" EnableEventValidation = "false"%>
            ...
            <td>
                <table width="100%" border="0" cellpadding="1" cellspacing="1" class="rcd-TableBorder">
                    ...
                    <tr>
                        ...
                        <td class="rcd-tableCell" style="width: 60%">
                        <asp:UpdatePanel ID="uptpnlapplication" runat="server">
                                 <contenttemplate>
                           <%-- <asp:DropDownList ID="ddlApplication" runat="server" SkinID="dropdownSkin" Width="156px"
                            ...
                            <cc1:ValidatorCalloutExtender ID="vceApplication" TargetControlID="rfvApplication"
								...
								<asp:TextBox ID="txtApplication_name" runat="server" width="55%"></asp:TextBox>

                             <asp:RequiredFieldValidator ID="rfvApplication" runat="server" ControlToValidate="txtApplication_name"
                                Display="None" SetFocusOnError="true" ValidationGroup="CheckData" ErrorMessage="Please Select Application">
                            </asp:RequiredFieldValidator>
                            <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender1" TargetControlID="rfvApplication"
                                runat="server" WarningIconImageUrl="../Images/Warning1.jpg">
                            </cc1:ValidatorCalloutExtender>

                            <cc1:PopupControlExtender ID="txtApplication_name_PopupControlExtender" runat="server" DynamicServicePath=""
                                Enabled="True" ExtenderControlID="btnTest" TargetControlID="txtApplication_name" PopupControlID="Panel1"
                                OffsetY="22">
                                </cc1:PopupControlExtender>
                            <asp:Panel ID="Panel1" runat="server" Height="116px" Width="250px" BorderStyle="Solid"
                                BorderWidth="2px" Direction="LeftToRight" ScrollBars="Auto" BackColor="#CCCCCC"
                                Style="display: none">
                                <asp:CheckBoxList ID="CheckBoxList1" runat="server" 
                                    DataTextField="holiday_name" DataValueField="ApplicationID_PK" AutoPostBack="True"
                            ...
                            <cc1:ValidatorCalloutExtender ID="vceIssueRequestType" TargetControlID="rfvIssueRequestType"
                             ...
                             <triggers>
                                <%-- <asp:AsyncPostBackTrigger ControlID="ddlApplication" EventName="SelectedIndexChanged"></asp:AsyncPostBackTrigger>                                                                                                                          --%>
                                    <asp:AsyncPostBackTrigger ControlID="CheckBoxList1" EventName="SelectedIndexChanged"></asp:AsyncPostBackTrigger>                                               
